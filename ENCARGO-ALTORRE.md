...
Son las ocho que trae el kit. Cada una es una ficha en `/maquinaria/{slug}/`.

| Familia | slug | Desde | Nota de venta |
|---|---|---|---|
| Excavadoras de cadenas | `excavadoras` | 240 €/día | De 1,8 t a 25 t. Martillo y cazo de limpieza incluidos en tarifa semanal. |
| Bulldozers | `bulldozers` | 480 €/día | D5 y D6. Para desmonte y explanación de parcelas grandes. |
| Cargadoras de ruedas | `cargadoras` | 290 €/día | De 1,5 a 3,5 m³. Acopio, carga de camión y áridos. |
| Retroexcavadoras mixtas | `retroexcavadoras` | 180 €/día | La máquina de todo. Zanja, carga y desplazamiento por carretera. |
| Grúas | `gruas` | 620 €/día | Autopropulsadas de 25 a 60 t. Siempre con operador y plan de izado. |
| Carretillas elevadoras | `carretillas` | 70 €/día | Diésel y todoterreno, de 2,5 a 7 t. Obra, nave y logística. |
| Motoniveladoras | `motoniveladoras` | 420 €/día | Caminos, viales y refino de explanada. Con GPS de nivelación. |
| Compactadoras y rodillos | `compactadoras` | 110 €/día | Tándem, monocilíndrico y bandeja. Zanja, vial y urbanización. |

Cada ficha lleva: para qué sirve de verdad · qué modelos hay · qué implementos entran ·
qué hace falta para manejarla · qué se cobra aparte · una obra real donde se usó.
...
- **Por semanas** — 20 % menos que la suma de días. 40 horas de horómetro.
...
**Lo que no entra en la tarifa:** combustible, operador (salvo grúas, que siempre lo llevan),
transporte fuera del radio de 30 km de la sede, implementos especiales y las horas de
horómetro que pasen del cupo. Todo eso va desglosado en el presupuesto, nunca de sorpresa.

## Sectores

Construcción y edificación · Obra civil y viales · Movimiento de tierras · Agrícola y
ganadero · Energías renovables (parques eólicos y plantas solares) · Demolición y reciclaje ·
Industria y logística · Administraciones públicas y ayuntamientos.
...
| Página | URL | Plantilla del kit |
|---|---|---|
| Inicio | `/` | Home |
| Maquinaria | `/maquinaria/` | Services |
| 8 fichas de familia | `/maquinaria/{slug}/` | Services Detail |
| Tarifas | `/tarifas/` | Pricing |
| Reservar máquina | `/reservar/` | Book Equipment |
| Nosotros | `/nosotros/` | About |
| Equipo | `/equipo/` | Team Detail |
| Opiniones | `/opiniones/` | Testimonials |
| Blog | `/blog/` | Blog |
| Contacto | `/contacto/` | Contact |
| Aviso legal | `/aviso-legal/` | — |
| Política de privacidad | `/politica-de-privacidad/` | — |
| Política de cookies | `/politica-de-cookies/` | — |
| Condiciones de alquiler | `/condiciones-de-alquiler/` | — |
| Error 404 | — | 404 |

## Formularios (Contact Form 7)

1. **Contacto** — nombre, empresa, teléfono, correo, mensaje.
2. **Pedir presupuesto** — nombre, empresa, teléfono, correo, población de la obra, familia de
   máquina, fechas, qué hay que hacer.
3. **Reserva rápida** (cabecera y home) — teléfono y qué necesita.

## Blog — categorías y primeros artículos

Categorías: Guías de máquina · Normativa y seguridad · Mantenimiento · Obra y terreno.

Pendiente de fase siguiente (no se escriben ahora): los artículos.
